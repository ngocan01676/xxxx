...
{
    /** Url path */
    const CMS_URL_PATH_EDIT = 'contact/contact/edit';
    const CMS_URL_PATH_DELETE = 'contact/contact/delete';
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                if (isset($item['contact_id'])) {
                    ...
                    $item[$name]['delete'] = [
                        'href' => $this->urlBuilder->getUrl(self::CMS_URL_PATH_DELETE, ['contact_id' => $item['contact_id']]),
                        'label' => __('Delete'),
                        'confirm' => [
